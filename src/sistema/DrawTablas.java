...
public class DrawTablas {
	...
	public DrawTablas(Context _ctx, String _campos, String _anchoTabla, int _anchoBorde, String _colorCabecera, String _colorCuerpo, String _colorBorde){
		this._tablaCtx 		= _ctx;
